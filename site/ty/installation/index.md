...
```
$ curl -LsSf https://astral.sh/ty/0.0.55/install.sh | sh
...
```
PS> powershell -ExecutionPolicy ByPass -c "irm https://astral.sh/ty/0.0.55/install.ps1 | iex"
...
- `ghcr.io/astral-sh/ty:{major}.{minor}.{patch}`, e.g., `ghcr.io/astral-sh/ty:0.0.55`
