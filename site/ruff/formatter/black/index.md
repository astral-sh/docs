...
In [preview](../../preview/), Ruff will keep lambda parameters on a single line, just like Black:
...
However, if the body expression exceeds the configured line length, Ruff will additionally add parentheses around the lambda body and break it over multiple lines:
