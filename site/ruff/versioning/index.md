...
Ruff's crates are published to [crates.io](https://crates.io). The following crates follow Ruff's normal versioning policy:
...
The remaining crates published as part of Ruff releases provide **no stability guarantees**. Their Rust interfaces are considered internal and unstable. Consequently, they are versioned as `0.0.x`. The patch version is incremented on every Ruff release, regardless of changes to the crate.
