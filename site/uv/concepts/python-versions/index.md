...
If the Python version was installed with preview enabled, e.g., `uv python install 3.12 --preview`, virtual environments using the Python version will be automatically upgraded to the new patch version.
